// Gonna use this file to build out resume manipulation data
// Basically... this is going to become a Terminal UI!
...
function addEntry(section, title, subtitle, startDate, endDate, link) {
  ...
  const nextPool = produce(EntryPool, (draft) => {
...
function sortPool() {
  ...
  const sortPool = produce(EntryPool, (draft) => {
